...
from project.tg_bot.router.client import start, error_handler, healthcheck, hello_world
...
main_client_tg_bot_router.include_router(router=error_handler.tg_bot_router)
