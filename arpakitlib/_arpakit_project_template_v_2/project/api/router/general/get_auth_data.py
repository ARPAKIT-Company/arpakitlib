...
from project.api.auth import APIAuthData, api_auth, correct_tokens_from_settings__validate_api_key_func, \
    correct_api_keys_from_settings__validate_api_key_func
